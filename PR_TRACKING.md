...
**Petite dette technique notée, pas urgente** : les labels S1-S8 sur les panneaux de coupe (composite ET exports individuels) s'affichent toujours, sans respecter la préférence `label_sections` (contrairement aux labels sur les vues, qui la respectent). À traiter le jour où Mathias le demande.
